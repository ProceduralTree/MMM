...
#+begin_src python  :session :results output file graphics  :file images/D.png
import numpy as np
import scipy as sp
...
Matrix Assembly
#+begin_src python :session :results output graphics file :file images/A-sparsity.png
...
#+begin_src python :session :file images/plot.png  :results output file graphics
...
#+begin_src python :results output file graphics :file images/T.png
...
#+begin_src python :results output file gaphics :file images/fine.png :session
N_fine = n*N
...
#+begin_src python :session :file images/multiscaleplot.png  :results output file graphics
...
#+RESULTS:
[[file:images/multiscaleplot.png]]
